...
#define tolerance 0.001		// Amount of change in temp before exiting
...
int main(void)
{
	...
	*/
	...
	float externalTemp = temperature[0] + temperature[1] + temperature[2] + temperature[3];
	float centralTemp = (2*centralTemp) + externalTemp;
        centralTemp /= 6.0;
...
//WORK HERE
        ...
        //if (updatedTemp == 0)
	float tempChange = prevCentralTemp-centralTemp;
	//float tempChange = 0.0001;
	printf("Temp change %f\n", tempChange);
